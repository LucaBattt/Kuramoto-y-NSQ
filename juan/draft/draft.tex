...
\title{Sincronizacion y encarrilamiento en redes complejas: una herramienta para el modelado del comportamiento del NSQ}% Force line breaks with \\
%\thanks{A footnote to the article title}%

\author{Luca Battiston}
\affiliation{%
%Instituto de F\'isica Enrique Gaviola (IFEG-CONICET), Ciudad Universitaria, 5000 C\'ordoba, Argentina.\\
Facultad de Matem\'atica, Astronom\'ia, F\'isica y Computaci\'on, Universidad Nacional de C\'ordoba, Ciudad Universitaria, 5000 C\'ordoba, Argentina.
...
\begin{figure}[b]
\includegraphics[scale=0.4]{assets/fig1.png}% Here is how to import EPS art
\caption{
\label{fig:1} 
Bla bla
}
...
%\begin{figure}[b]
%\includegraphics{assets/fig1}% Here is how to import EPS art
...
NVB and JIP acknowledge financial support from grants CONICET (PIP 112 20150 10028), FonCyT (PICT-2017-0973), SeCyT–UNC (Argentina) and MinCyT C\'ordoba (PID PGC 2018). 
{\color{red}[FALTA ACTUALIZAR]}
